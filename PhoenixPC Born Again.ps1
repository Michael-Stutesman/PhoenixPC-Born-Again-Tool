...
public class Win32 {
	...
	[DllImport("user32.dll")]
	public static extern void SwitchToThisWindow(IntPtr hWnd, bool tfUnknown);
...
# List of network-related services to restart
$netSvcs = @(
	'Dhcp',             # DHCP Client
	'Dnscache',         # DNS Client
	...
	'LanmanWorkstation',# Workstation service (network shares)
	'LanmanServer',     # Server service (network sharing)
